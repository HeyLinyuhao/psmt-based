...
def main(gpu,  ngpus_per_node, config, args):
    ...
    if args.ddp:
        ...
        if args.gcloud:
            if args.local_rank <= 0:
                ...
                download_voc_unzip(data_dir="./VOCtrainval_11-May-2012", prefix="yh/exercise_4/")
    ...
    config['all_loader']['n_labeled_examples'] = config['n_labeled_examples']
    ...
    pretrain_loader = VOC(config['all_loader'], ddp_training=args.ddp, dgx=args.dgx)
