...
class VOCDataset(BaseDataSet):
    ...
    def _set_files(self):
        ...
        if self.split == "val":
            ...
            file_list1 = os.path.join(prefix, "DataLoader/voc_splits", f"{self.n_labeled_examples}"+"_"+"train_supervised" + ".txt") 
            file_list2 = os.path.join(prefix, "DataLoader/voc_splits", f"{self.n_labeled_examples}"+"_"+"train_unsupervised" + ".txt")
        else:
        ...
        if self.split == "all":
            file_list1 = [line.rstrip().split(' ') for line in tuple(open(file_list1, "r"))]
            file_list2 = [line.rstrip().split(' ') for line in tuple(open(file_list2, "r"))]
